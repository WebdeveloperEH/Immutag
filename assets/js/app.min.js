...
!(function (e, t) {
  ...
  $.on(
    ...
    b(function () {
      ...
      if (e) {
        var t = e.fn.button;
        (e.fn.button = W.jQueryInterface),
          (e.fn.button.Constructor = W),
    ...
    Q = (function (e) {
      function s(t, i) {
        ...
        return (
          ...
          (n._indicatorsElement = Y.findOne(
            ".carousel-indicators",
            n._element
          )),
          (n._touchSupported =
      ...
      return (
        ...
        (r._triggerSlideEvent = function (e, t) {
          var i = this._getItemIndex(e),
            n = this._getItemIndex(
              Y.findOne(".active.carousel-item", this._element)
            );
        ...
        (r._setActiveIndicatorElement = function (e) {
          if (this._indicatorsElement) {
            for (
              var t = Y.find(".active", this._indicatorsElement), i = 0;
              i < t.length;
              i++
            )
  ...
  $.on(
    ...
    $.on(window, "load.bs.carousel.data-api", function () {
      for (
        var e = Y.find('[data-bs-ride="carousel"]'), t = 0, i = e.length;
        t < i;
        t++
      )
  ...
  var K = "collapse",
    ...
    ee = (function (e) {
      function s(t, i) {
        ...
        for (
          var s = Y.find('[data-bs-toggle="collapse"]'), r = 0, o = s.length;
          r < o;
          r++
        ) {
          var a = s[r],
      ...
      return (
        ...
        (r.show = function () {
          ...
          if (
            ...
            this._parent &&
              0 ===
                (t = Y.find(".show, .collapsing", this._parent).filter(
                  function (t) {
  ...
  function _e(e) {
    for (var t = de(e), i = Ee(e); i && ye(i) && "static" === ve(i).position; )
      i = Ee(i);
  ...
  function Ge(e, t) {
    ...
    var i = t,
      ...
      E = $e(v),
      _ = Ye({ reference: E, element: y, strategy: "absolute", placement: s }),
  ...
  var st = nt(),
    rt = nt({ defaultModifiers: [Oe, Ze, Ae, fe] }),
    ot = nt({ defaultModifiers: [Oe, Ze, Ae, fe, Ke, Xe, Je, Me, Qe] }),
    at = Object.freeze({
      __proto__: null,
      popperGenerator: nt,
      detectOverflow: Ge,
      ...
      return (
        ...
        (s.clearMenus = function (e) {
          if (!e || (2 !== e.button && ("keyup" !== e.type || "Tab" === e.key)))
            for (
              var t = Y.find('[data-bs-toggle="dropdown"]'),
                i = 0,
                n = t.length;
              i < n;
              i++
                ...
                if (
                  ...
                  !(
                    (e &&
                      ...
                      c.contains(e.target)) ||
                    $.trigger(r, "hide.bs.dropdown", a).defaultPrevented
                  )
                )
                  "ontouchstart" in document.documentElement &&
                    (l = []).concat
            ...
            if ("Escape" === e.key)
              return (
                (this.matches('[data-bs-toggle="dropdown"]')
                  ? this
                  : Y.prev(this, '[data-bs-toggle="dropdown"]')[0]
                ).focus(),
                void s.clearMenus()
              );
            if (i && "Space" !== e.key) {
      ...
      return (
        ...
        (r._setScrollbar = function () {
          ...
          if (this._isBodyOverflowing) {
            Y.find(".fixed-top, .fixed-bottom, .is-fixed, .sticky-top").forEach(
              function (t) {
      ...
      return (
        ...
        (r._getContainer = function () {
          return !1 === this.config.container
            ...
            : Y.findOne(this.config.container);
        }),
  ...
  b(function () {
    ...
    if (e) {
      var t = e.fn[Ct];
      (e.fn[Ct] = kt.jQueryInterface),
        (e.fn[Ct].Constructor = kt),
  ...
  var zt = "popover",
    ...
    $t = i({}, kt.DefaultType, { content: "(string|element|function)" }),
    Nt = {
      ...
      return (
        ...
        (i.jQueryInterface = function (e) {
          return this.each(function () {
            ...
            if (
              (t || !/dispose|hide/.test(e)) &&
              (t || ((t = new i(this, n)), _(this, "bs.popover", t)),
              "string" == typeof e)
            ) {
              if (void 0 === t[e])
                throw new TypeError('No method named "' + e + '"');
  ...
  b(function () {
    ...
    if (e) {
      var t = e.fn[zt];
      (e.fn[zt] = Ht.jQueryInterface),
        (e.fn[zt].Constructor = Ht),
    ...
    Ft = (function (e) {
      ...
      return (
        ...
        (r._getConfig = function (e) {
          if (
            "string" !=
              typeof (e = i({}, Wt, "object" == typeof e && e ? e : {}))
                .target &&
            p(e.target)
          ) {
            var t = e.target.id;
  ...
  $.on(window, "load.bs.scrollspy.data-api", function () {
    ...
    b(function () {
      ...
      if (e) {
        var t = e.fn[Bt];
        (e.fn[Bt] = Ft.jQueryInterface),
          (e.fn[Bt].Constructor = Ft),
      ...
      open: function (i) {
        ...
        if (!t.isOpen) {
          (t.types = []),
            ...
            t.bgOverlay ||
              ((t.bgOverlay = E("bg").on("click" + f, function () {
                t.close();
              })),
              (t.wrap = E("wrap")
                .attr("tabindex", -1)
        ...
        getInline: function (i, n) {
          if ((I(), i.src)) {
            ...
            if (r.length) {
              ...
              o &&
                o.tagName &&
                (C || ((T = s.hiddenClass), (C = E(T)), (T = "mfp-" + T)),
...
($jscomp.scope = {}),
  ...
  ($jscomp.defineProperty =
    $jscomp.ASSUME_ES5 || "function" == typeof Object.defineProperties
      ...
      : function (e, t, i) {
          return (
            e == Array.prototype || e == Object.prototype || (e[t] = i.value), e
          );
        }),
...
($jscomp.polyfill = function (e, t, i, n) {
  t &&
    ($jscomp.ISOLATE_POLYFILLS
      ? $jscomp.polyfillIsolated(e, t, i, n)
      : $jscomp.polyfillUnisolated(e, t, i, n));
}),
  ...
  ($jscomp.polyfillIsolated = function (e, t, i, n) {
    ...
    (s = s[s.length - 1]),
      null !=
        (t = t((i = $jscomp.IS_SYMBOL_NATIVE && "es6" === i ? n[s] : null))) &&
        (e
          ? $jscomp.defineProperty($jscomp.polyfills, s, {
              configurable: !0,
              writable: !0,
              value: t,
            })
          : t !== i &&
            (($jscomp.propertyToPolyfillSymbol[s] = $jscomp.IS_SYMBOL_NATIVE
              ? $jscomp.global.Symbol(s)
              : $jscomp.POLYFILL_PREFIX + s),
  ...
  $jscomp.polyfill(
    ...
    function (e) {
      ...
      for (
        ...
        "function" == typeof n &&
          "function" != typeof n.prototype[e] &&
          $jscomp.defineProperty(n.prototype, e, {
            configurable: !0,
            writable: !0,
            value: function () {
    ...
    return (
      (n = {
        setEvents: function (e) {
          ...
          if (
            (o && !e && window.addEventListener("load", n.runQuery),
            ...
            return (
              Object.keys(e).forEach(function (s) {
                "[object Object]" === Object.prototype.toString.call(e[s])
                  ? (i[s] = n.setOptions(e[s], t[s]))
                  : ((i[s] = e[s]),
                    void 0 !== t && void 0 !== t[s] && (i[s] = t[s]));
              }),
              i
            );
        },
        searchElements: function () {
          ...
          for (
            ...
            for (var r = t[s], o = 0; o < r.children.length; o++) {
              var l = r.children[o];
              n.setAttrPtoC(l, "data-cue", r, "data-cues", ""),
                n.setAttrPtoC(l, "data-duration", r, "data-duration", !1),
                n.setAttrPtoC(l, "data-interval", r, "data-interval", !1),
                n.setAttrPtoC(l, "data-sort", r, "data-sort", !1),
                n.setAttrPtoC(l, "data-addClass", r, "data-addClass", !1),
                n.setAttrPtoC(l, "data-group", r, "data-group", !1),
                n.setAttrPtoC(l, "data-delay", r, "data-delay", !1);
            }
            ...
            for (t = docSlider.getElements().pages.length, s = 0; s < t; s++)
              for (
                r = document.querySelectorAll(
                  '[data-ds-index="' + s + '"] [data-cue]:not([data-scpage])'
                ),
                  o = 0;
                o < r.length;
                o++
              )
                r[o].setAttribute("data-scpage", s);
        },
        sortElements: function () {
          for (
            var e = arguments[0],
              t = [].slice.call(arguments).slice(1),
              i = { $jscomp$loop$prop$i$4: 0 };
            i.$jscomp$loop$prop$i$4 < t.length;
            (i = { $jscomp$loop$prop$i$4: i.$jscomp$loop$prop$i$4 })
            ...
            e.sort(
              (function (e) {
                return function (i, n) {
                  var s =
                      void 0 === t[e.$jscomp$loop$prop$i$4][1] ||
                      t[e.$jscomp$loop$prop$i$4][1],
        ...
        setAttrPtoC: function (e, t, i, n, s) {
          i.hasAttribute(n)
            ? e.hasAttribute(t) || e.setAttribute(t, i.getAttribute(n))
            : !1 !== s && e.setAttribute(t, s);
        },
          ...
          for (var i = 0; i < e.length; i++) {
            ...
            if (!s.elm.hasAttribute("data-show")) {
              if (a) {
                ...
                if (o !== docSlider.getCurrentIndex() + "" && null !== o)
                  continue;
              }
        ...
        runQuery: function () {
          for (
            ...
            if (
              ((i.$jscomp$loop$prop$elms$6 = t[e[s]]),
              n.isElementIn(i.$jscomp$loop$prop$elms$6[0].elm))
            ) {
              "reverse" === i.$jscomp$loop$prop$elms$6[0].sort
                ? i.$jscomp$loop$prop$elms$6.reverse()
                : "random" === i.$jscomp$loop$prop$elms$6[0].sort &&
                  n.randElements(i.$jscomp$loop$prop$elms$6),
                n.sortElements(i.$jscomp$loop$prop$elms$6, ["order"]);
              for (
                var r = (i.$jscomp$loop$prop$interval$7 = 0);
                r < i.$jscomp$loop$prop$elms$6.length;
                r++
              )
                !(function (e) {
                  return function (t) {
                    e.$jscomp$loop$prop$elms$6[t].elm.setAttribute(
                      ...
                      (e.$jscomp$loop$prop$interval$7 = n.setDurationValue(
        ...
        isElementIn: function (e) {
          var t = e.hasAttribute("data-scpage")
            ? n.isScrollEndWithDocSlider
            : n.isScrollEnd;
          return (
            window.pageYOffset >
              n.getOffsetTop(e) - window.innerHeight * i.percentage || t()
          );
        },
      ...
      }),
      {
        init: function (e) {
          (i = n.setOptions(c, e)),
            ...
            (a = i.docSlider),
            (l = i.pageChangeReset),
            a || (n.setEvents(), n.searchElements(), n.setQuery());
        },
        update: function () {
          o && (n.searchElements(), n.setQuery(), n.runQuery());
        },
  ...
  Swiper = (function () {
    ...
    function H(e) {
      ...
      if ("touchstart" === s.type)
        return void N(t, s, s.targetTouches[0].pageX);
      const { params: a, touches: c, enabled: d } = t;
      if (!d) return;
      ...
      u.matches(o.focusableElements) &&
        ((y = !1), "SELECT" === u.nodeName && (o.isTouched = !1)),
        i.activeElement &&
          i.activeElement.matches(o.focusableElements) &&
          i.activeElement !== u &&
          ("mouse" === s.pointerType ||
            ("mouse" !== s.pointerType && !u.matches(o.focusableElements))) &&
    ...
    function B(e) {
      const t = n(),
        i = this,
        s = i.touchEventsData,
        { params: r, touches: o, rtlTranslate: a, enabled: c } = i;
      if (!c) return;
      ...
      if (!i.allowTouchMove)
        return (
          u.target.matches(s.focusableElements) || (i.allowClick = !1),
          void (
            s.isTouched &&
            (Object.assign(o, {
              startX: p,
      ...
      if (r.touchReleaseOnEdges && !r.loop)
        if (i.isVertical()) {
          ...
          (p < o.startX && i.translate <= i.maxTranslate()) ||
          (p > o.startX && i.translate >= i.minTranslate())
        )
          return;
      if (
        (t.activeElement &&
      ...
      s.allowTouchCallbacks && i.emit("touchMove", u),
      ...
      if (i.params.threshold && Math.sqrt(h ** 2 + m ** 2) < i.params.threshold)
        return;
      ...
      if (
        (s.isScrolling && i.emit("touchMoveOpposite", u),
            ...
            s.currentTranslate > i.minTranslate() &&
              ...
              r.resistance &&
                (s.currentTranslate =
                  i.minTranslate() -
                  1 +
                  (-i.minTranslate() + s.startTranslate + g) ** _)))
          : g < 0 &&
            (b &&
              w &&
              s.allowThresholdMove &&
            ...
            s.currentTranslate < i.maxTranslate() &&
              ...
              r.resistance &&
                (s.currentTranslate =
                  i.maxTranslate() +
                  1 -
                  (i.maxTranslate() - s.startTranslate - g) ** _))),
    ...
    function W(e) {
      ...
      if (
        ...
        if (
          ((n = [...s.changedTouches].find((e) => e.identifier === i.touchId)),
      ...
      if (f > r.longSwipesMs) {
        ...
        "next" === t.swipeDirection &&
          (w >= r.longSwipesRatio
            ? t.slideTo(r.rewind && t.isEnd ? y : g + E)
            : t.slideTo(g)),
        ...
        (s.target !== t.navigation.nextEl && s.target !== t.navigation.prevEl)
          ? ("next" === t.swipeDirection && t.slideTo(null !== y ? y : g + E),
    ...
    const K = {
        ...
        update: {
          updateSize: function () {
            ...
            (t =
              ...
              (0 === t && e.isHorizontal()) ||
                ...
                ((t =
                  t -
                  parseInt(b(n, "padding-left") || 0, 10) -
                  parseInt(b(n, "padding-right") || 0, 10)),
                (i =
                  i -
                  parseInt(b(n, "padding-top") || 0, 10) -
                  parseInt(b(n, "padding-bottom") || 0, 10)),
                Number.isNaN(t) && (t = 0),
                Number.isNaN(i) && (i = 0),
                Object.assign(e, {
                  width: t,
          ...
          updateSlides: function () {
            ...
            "string" == typeof _ && _.indexOf("%") >= 0
              ...
              i.centeredSlides &&
                i.cssMode &&
                (p(n, "--swiper-centered-offset-before", ""),
            ...
            for (let n = 0; n < u; n += 1) {
              ...
              if (
                ...
                if ("auto" === i.slidesPerView) {
                  ...
                  (L = (r - (i.slidesPerView - 1) * _) / i.slidesPerView),
                    i.roundLengths && (L = Math.floor(L)),
                    d[n] &&
                      (d[n].style[e.getDirectionLabel("width")] = L + "px");
                d[n] && (d[n].swiperSlideSize = L),
                  g.push(L),
                  i.centeredSlides
                    ? ((S = S + L / 2 + T / 2 + _),
                      0 === T && 0 !== n && (S = S - r / 2 - _),
            ...
            if (
              ...
              o &&
                ...
                (n.style.width = e.virtualSize + _ + "px"),
              i.setWrapperSize &&
                (n.style[e.getDirectionLabel("width")] =
                  e.virtualSize + _ + "px"),
              M && e.grid.updateWrapperSize(L, f),
              !i.centeredSlides)
            ) {
              const t = [];
              for (let n = 0; n < f.length; n += 1) {
                let s = f[n];
                i.roundLengths && (s = Math.floor(s)),
                  f[n] <= e.virtualSize - r && t.push(s);
              }
              (f = t),
                Math.floor(e.virtualSize - r) - Math.floor(f[f.length - 1]) >
            ...
            if (
              ...
              p(n, "--swiper-centered-offset-before", -f[0] + "px"),
                p(
                  n,
          ...
          updateSlidesProgress: function (e) {
            ...
            for (let e = 0; e < n.length; e += 1) {
              ...
              m && (t.visibleSlides.push(l), t.visibleSlidesIndexes.push(e)),
                ...
                O(l, h, i.slideFullyVisibleClass),
                (l.progress = s ? -d : d),
          ...
          updateSlidesClasses: function () {
            ...
            l &&
              ...
              t.forEach((e) => {
                k(e, e === l, i.slideActiveClass),
                  k(e, e === d, i.slideNextClass),
                  k(e, e === c, i.slidePrevClass);
              }),
              e.emitSlidesClasses();
          },
        ...
        slide: {
          slideTo: function (e, t, i, n, s) {
            ...
            const E = P().isSafari;
            return (
              w && !s && E && r.isElement && r.virtual.update(!1, !1, o),
              r.setTransition(t),
              r.setTranslate(y),
              r.updateActiveIndex(o),
              r.updateSlidesClasses(),
              ...
              (s = parseInt(
                ...
                t.centeredSlides
                  ? r < e.loopedSlides - n / 2 ||
                    ...
                    ? (e.loopFix(),
                      (r = e.getSlideIndex(
                        m(i, `${o}[data-swiper-slide-index="${s}"]`)[0]
                      )),
                      a(() => {
                        e.slideTo(r);
                      }))
        ...
        loop: {
          ...
          loopFix: function (e) {
            ...
            const M = b ? Math.ceil(c.length / f.grid.rows) : c.length,
              L =
                (b ? c[r].column : r) + (h && void 0 === s ? -m / 2 + 0.5 : 0);
            if (L < y) {
              T = Math.max(y - L, v);
    ...
    class J {
      ...
      getSlideIndex(e) {
        const { slidesEl: t, params: i } = this,
          n = w(m(t, `.${i.slideClass}, swiper-slide`)[0]);
        return w(e) - n;
      }
        ...
        return (
          ...
          Object.assign(t, {
            ...
            rtlTranslate:
              ...
              ("rtl" === i.dir.toLowerCase() || "rtl" === b(i, "direction")),
      ...
      return (
        e.params.createElements &&
          Object.keys(n).forEach((s) => {
            if (!i[s] && !0 === i.auto) {
              let r = m(e.el, "." + n[s])[0];
              r || ((r = v("div", n[s])), (r.className = n[s]), e.el.append(r)),
                (i[s] = r),
                (t[s] = r);
            }
          }),
    ...
    const ue = [
      function (e) {
        ...
        function d(e, t, n) {
          ...
          const { addSlidesBefore: u, addSlidesAfter: p } = i.params.virtual,
            { from: f, to: h, slides: g, slidesGrid: v, offset: y } = i.virtual;
          i.params.cssMode || i.updateActiveIndex();
          const b = void 0 === n ? i.activeIndex || 0 : n;
          let w, E, _;
          (w = i.rtlTranslate ? "right" : i.isHorizontal() ? "left" : "top"),
            a
              ? ((E = Math.floor(s / 2) + r + p),
                (_ = Math.floor(s / 2) + r + u))
              : ((E = s + (r - 1) + p), (_ = (l ? s : r) + u));
          let x = b - _,
            S = b + E;
          ...
          if (
            (l && b >= _
              ? ((x -= _), a || (T += i.slidesGrid[0]))
              : l && b < _ && ((x = -_), a && (T += i.slidesGrid[0])),
      ...
      function (e) {
        ...
        function u() {
          ...
          if (
            ...
            if (
              (i.dynamicBullets &&
                ((o = x(s[0], t.isHorizontal() ? "width" : "height", !0)),
                d.forEach((e) => {
          ...
          d.forEach((e, r) => {
            if (
              ("fraction" === i.type &&
                (e.querySelectorAll(te(i.currentClass)).forEach((e) => {
              ...
              "horizontal" === s ? (o = r) : (a = r),
                e.querySelectorAll(te(i.progressbarFillClass)).forEach((e) => {
                  (e.style.transform = `translate3d(0,0,0) scaleX(${o}) scaleY(${a})`),
                    (e.style.transitionDuration = t.params.speed + "ms");
                });
            }
            "custom" === i.type && i.renderCustom
              ? ((e.innerHTML = i.renderCustom(t, n + 1, p)),
              ...
              "custom" !== e.type && (i.innerHTML = r || ""),
                "bullets" === e.type &&
                  t.pagination.bullets.push(
                    ...i.querySelectorAll(te(e.bulletClass))
                  );
            }),
      ...
      function (e) {
        ...
        function C(e) {
          ...
          const r = s,
            ...
            a = !!n.passiveListeners && { passive: !0, capture: !1 };
          if (!r) return;
        ...
        function M() {
          ...
          t.params.uniqueNavElements &&
            ...
            s &&
              ((r = s.querySelector(te(t.params.scrollbar.dragClass))),
              r || ((r = v("div", t.params.scrollbar.dragClass)), s.append(r))),
            Object.assign(e, { el: s, dragEl: r }),
            n.draggable && t.params.scrollbar.el && t.scrollbar.el && C("on"),
            s &&
      ...
      function (e) {
        ...
        function M(e) {
          if (("mouse" === e.pointerType && h.splice(0, h.length), !T(e)))
            return;
        ...
        function L(e) {
          ...
          s >= 0 && (h[s] = e),
            h.length < 2 ||
              ...
              (g.scaleMove = x()),
              g.imageEl &&
                ((n.scale = (g.scaleMove / g.scaleStart) * a),
                n.scale > g.maxRatio &&
                  (n.scale =
                    g.maxRatio - 1 + (n.scale - g.maxRatio + 1) ** 0.5),
                n.scale < i.minRatio &&
                  (n.scale =
        ...
        function P(e) {
          ...
          v.isMoved ||
            ...
            (v.startX = c(g.imageWrapEl, "x") || 0),
            (v.startY = c(g.imageWrapEl, "y") || 0),
          ...
          const s = v.width * n.scale,
            r = v.height * n.scale;
          if (
            ((v.minX = Math.min(g.slideWidth / 2 - s / 2, 0)),
            (v.maxX = -v.minX),
        ...
        function k(e) {
          ...
          (g.imageWrapEl.style.transitionDuration = "0ms"),
            (g.imageWrapEl.style.transform = `translate3d(${b}px, ${w}px, 0)`),
            (u.x = e.clientX),
            (u.y = e.clientY),
            (v.startX = b),
            (v.startY = w);
        ...
        function z(e) {
          ...
          if (!g.slideEl) {
            ...
            i &&
              ...
              (g.imageEl = i),
              (g.imageWrapEl = i
                ? E(g.imageEl, "." + n.containerClass)[0]
                : void 0);
          }
          ...
          t.params.cssMode &&
            ...
            void 0 === v.touchesStart.x && e
              ? ((s = e.pageX), (r = e.pageY))
              : ((s = v.touchesStart.x), (r = v.touchesStart.y));
          ...
          (i.scale = A || P),
            ...
            !e || (1 === a && A)
              ...
              : ((L = g.slideEl.offsetWidth),
                ...
                (w = h * i.scale),
                (_ = b * i.scale),
                (x = Math.min(L / 2 - w / 2, 0)),
                (T = Math.min(I / 2 - _ / 2, 0)),
                (C = -x),
                (M = -T),
                (p = d * i.scale),
                (f = u * i.scale),
                ...
                f < T && (f = T),
                f > M && (f = M)),
            A && 1 === i.scale && ((g.originX = 0), (g.originY = 0)),
            (g.imageWrapEl.style.transitionDuration = "300ms"),
            (g.imageWrapEl.style.transform = `translate3d(${p}px, ${f}px,0)`),
        ...
        function D() {
          ...
          if (!g.slideEl) {
            t.params.virtual && t.params.virtual.enabled && t.virtual
              ? (g.slideEl = m(t.slidesEl, "." + t.params.slideActiveClass)[0])
              : (g.slideEl = t.slides[t.activeIndex]);
        ...
        function N() {
          ...
          t.wrapperEl.addEventListener("pointerdown", M, i),
            t.wrapperEl.addEventListener("pointermove", L, n),
        ...
        function H() {
          ...
          e.enabled = !1;
          const { passiveListener: i, activeListenerWithCapture: n } = $();
          t.wrapperEl.removeEventListener("pointerdown", M, i),
            t.wrapperEl.removeEventListener("pointermove", L, n),
            ["pointerup", "pointercancel", "pointerout"].forEach((e) => {
            ...
            t.zoom.enabled &&
              (function () {
                ...
                const s = b.x * i,
                  ...
                  o = b.y * n,
                  a = v.currentY + o;
                0 !== b.x && (i = Math.abs((r - v.currentX) / b.x)),
                  0 !== b.y && (n = Math.abs((a - v.currentY) / b.y));
                const l = Math.max(i, n);
                (v.currentX = r), (v.currentY = a);
                const c = v.width * e.scale,
                  d = v.height * e.scale;
                (v.minX = Math.min(g.slideWidth / 2 - c / 2, 0)),
                  (v.maxX = -v.minX),
        ...
        function y(e) {
          ...
          if (
            ...
            if (t.navigation && t.navigation.prevEl && t.navigation.nextEl) {
              ...
              S(t.navigation.nextEl).includes(n) &&
            ...
            t.pagination &&
              n.matches(te(t.params.pagination.bulletClass)) &&
              n.click();
          }
        }
        function b() {
            ...
            t.params.a11y.enabled &&
              (() => {
                ...
                e.containerRoleDescriptionMessage &&
                  f(i, e.containerRoleDescriptionMessage),
                ...
                (d = S(d)),
                  (u = S(u)),
                  d && d.forEach((t) => _(t, r, e.nextSlideMessage)),
                  u && u.forEach((t) => _(t, r, e.prevSlideMessage)),
                  E() &&
                ...
                b() &&
                  t.pagination.bullets.forEach((i) => {
                    t.params.pagination.clickable &&
                      ...
                      i.matches(te(t.params.pagination.bulletActiveClass))
        ...
        const E = () => {
                  ...
                  (s.params.autoplay.reverseDirection
                    ? !s.isBeginning || s.params.loop || s.params.rewind
                      ...
                      : s.params.autoplay.stopOnLastSlide ||
                        (s.slideTo(s.slides.length - 1, o, !0, !0),
                        a("autoplay"))
          ...
          T = (e, i) => {
            ...
            if (((s.autoplay.paused = !0), i))
              return h && (c = s.params.autoplay.delay), (h = !1), void n();
            const r = c || s.params.autoplay.delay;
            (c = r - (new Date().getTime() - b)),
          ...
          L = (e) => {
            "mouse" === e.pointerType &&
              ((m = !0), (g = !0), s.animating || s.autoplay.paused || T(!0));
          },
          I = (e) => {
        ...
        o("init", () => {
          s.params.autoplay.enabled &&
            (s.params.autoplay.pauseOnMouseEnter &&
              (s.el.addEventListener("pointerenter", L),
          ...
          o("destroy", () => {
            s.el &&
              "string" != typeof s.el &&
              (s.el.removeEventListener("pointerenter", L),
          ...
          setTranslate: () => {
            ...
            for (let e = 0; e < n.length; e += 1) {
              ...
              i % 4 == 0
                ...
                a && (h = -h),
                p || ((g = h), (h = 0));
              const y = `rotateX(${d(p ? 0 : -r)}deg) rotateY(${d(
                p ? r : 0
              )}deg) translate3d(${h}px, ${g}px, ${v}px)`;
              c <= 1 &&
                c > -1 &&
                ((m = 90 * i + 90 * c), a && (m = 90 * -i - 90 * c)),
                (t.style.transform = y),
            ...
            (i.style.transform = `translate3d(0px,0,${g}px) rotateX(${d(
              t.isHorizontal() ? 0 : m
        ...
        const s = (e, i) => {
          let n = t.isHorizontal()
            ...
            s = t.isHorizontal()
              ? e.querySelector(".swiper-slide-shadow-right")
              : e.querySelector(".swiper-slide-shadow-bottom");
          n || (n = de("flip", e, t.isHorizontal() ? "left" : "top")),
            s || (s = de("flip", e, t.isHorizontal() ? "right" : "bottom")),
        ...
        ae({
          ...
          setTranslate: () => {
            ...
            for (let o = 0; o < e.length; o += 1) {
              ...
              const h = `translate3d(${p}px, ${f}px, 0px) rotateX(${r(
                u
              )}deg) rotateY(${r(d)}deg)`;
          ...
          setTransition: (e) => {
            ...
            i.forEach((t) => {
              ...
              ce({ swiper: t, duration: e, transformElements: i });
          },
          recreateShadows: () => {
            t.params.flipEffect,
              t.slides.forEach((e) => {
          ...
          ae({
            ...
            setTranslate: () => {
              ...
              for (let e = 0, t = n.length; e < t; e += 1) {
                ...
                const w = `translate3d(${y}px,${v}px,${m}px)  rotateX(${u(
                  h
                )}deg) rotateY(${u(f)}deg) scale(${b})`;
                if (
                  ((le(0, t).style.transform = w),
                  ...
                  e || (e = de("coverflow", t, o ? "left" : "top")),
                    i || (i = de("coverflow", t, o ? "right" : "bottom")),
          ...
          setTranslate: () => {
            ...
            for (let i = 0; i < e.length; i += 1) {
              ...
              d < 0
                ...
                : d > 0 && ((g = r.prev), (m = !0)),
                f.forEach((e, t) => {
                  f[t] = `calc(${e}px + (${s(g.translate[t])} * ${Math.abs(
                    d * o
                  )}))`;
                }),
                h.forEach((e, t) => {
              ...
              const v = f.join(", "),
                y = `rotateX(${l(h[0])}deg) rotateY(${l(h[1])}deg) rotateZ(${l(
                  h[2]
                )}deg)`,
                b =
                  u < 0
                    ? `scale(${1 + (1 - g.scale) * u * o})`
                    : `scale(${1 - (1 - g.scale) * u * o})`,
                w =
                  u < 0
                    ? 1 + (1 - g.opacity) * u * o
